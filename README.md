...
- `Upgrades` opens the permanent skill tree. Nodes use compact icons and rank text; compact hover cards show the per-rank increase, the live value before and after purchase, and a centered currency cost. Affordable hovered upgrades glow white, unavailable ones glow red, and maxed ones glow teal. Purchases happen directly on the node.
